...
# Configuration
# --------------------------------------------------------------------------- #
# Anchor the model path to THIS file's folder, so it works no matter what the
# current working directory is (Streamlit Cloud runs from the repo root, not
# from the app's subfolder).
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
MODEL_PATH = os.path.join(BASE_DIR, "potato_disease_model.keras")
